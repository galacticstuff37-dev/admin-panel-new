          ...
          <table className="w-full border-collapse font-sofia text-base">
            ...
            <tbody>
              {MOCK_PLAYERS.map((player) => (
                <tr
                  key={player.id}
                  className="border-b border-contour last:border-b-0 hover:bg-white/5 transition-colors"
                >
                  ...
                  <td className="py-3 px-4">
                    <Link
                      ...
                      className="font-sofia font-bold text-primary hover:text-primary-high uppercase text-sm"
                    >
                      Open →
                    </Link>
                  </td>
